...
#### 10. To require the ^1.0.1 tag of ez decoupled, execute this command
```bash
...
#### 11. To require the ^1.0.1 tag of ez decoupled, execute this command
```bash
...
#### 9. To require the ^1.0.1 tag of ez decoupled, execute this command
```bash
composer require srijanone/ez_article:^1.0.1
```
